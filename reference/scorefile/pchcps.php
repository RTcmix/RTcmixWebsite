...
<b>pchcps</b> - convert frequency (Hz) to octave.pitch-class (oct.pc)
...
<h3>Description</h3>
<P>
<b>pchcps</b> returns a corresponding "octave.pitch-class" (<i>oct.pc</i>)
value for a given frequency value (Hz).
<i>oct.pc</i> is a way
